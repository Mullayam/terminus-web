        ...
        <div>
            ...
            {isSSH_Connected ? <>
                ...
                <div className="bg-gray-900 text-gray-200 p-1 text-xs text-right">
                    Status: {isSSH_Connected ? <div className="inline-flex items-center">
                ...
                <Alert>
                    <AlertDescription>SSH connection established successfully!Do No Refresh the page , otherwise the connection will be lost</AlertDescription>
                </Alert>
