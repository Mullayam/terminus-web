          ...
          {filtered.map((cmd, i) => (
            <div key={`${cmd}-${i}`}>
              ...
              >
                ...
                {/* Command text */}
                <span className="flex-1 text-xs font-mono truncate select-none">
                  {cmd}
                </span>
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[10px] font-medium shrink-0"
                  style={{
